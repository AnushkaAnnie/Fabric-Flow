/*
  ...
  - You are about to drop the column `hk_no` on the `Compacting` table. All the data in the column will be lost.
  - You are about to drop the column `hk_no` on the `Dyeing` table. All the data in the column will be lost.
  - You are about to drop the column `hk_no` on the `Knitting` table. All the data in the column will be lost.
  - You are about to drop the column `hk_no` on the `Yarn` table. All the data in the column will be lost.
  - Added the required column `hf_code` to the `Compacting` table without a default value. This is not possible if the table is not empty.
  - Added the required column `hf_code` to the `Dyeing` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Yarn" ("bag_weight", "count", "createdAt", "date", "description", "hf_code", "id", "mill_name_id", "no_of_bags", "quality", "rate_per_kg", "total_cost", "total_weight", "updatedAt") SELECT "bag_weight", "count", "createdAt", "date", "description", "hf_code", "id", "mill_name_id", "no_of_bags", "quality", "rate_per_kg", "total_cost", "total_weight", "updatedAt" FROM "Yarn";
DROP TABLE "Yarn";
ALTER TABLE "new_Yarn" RENAME TO "Yarn";
CREATE UNIQUE INDEX "Yarn_hf_code_key" ON "Yarn"("hf_code");
